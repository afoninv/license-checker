...
// Tweaked https://github.com/meetearnest/global-request-logger - with request timings
...
function attachLoggersToRequest(protocol, options, callback) {
  ...
  logInfo.request.timingStart = (new Date()).getTime();  
  ...
  req.on('error', function (error) {
    ...
    logInfo.response.timingEnd = (new Date()).getTime();  
